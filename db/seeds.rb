...
dance_classes = DanceClass.create([
  ...
  {text: 'Stretch & Strength', studio_id: Studio.find_by(name: 'Movement Lifestyle').id, instructor_id: Instructor.find_by(name: 'Sienna Lyons').id, day: 'WEDNESDAY', day_index: 3, start_time: '12:00p', end_time: '1:20pm'},
  ...
  {text: 'Mat Pilates', studio_id: Studio.find_by(name: 'Movement Lifestyle').id, instructor_id: Instructor.find_by(name: 'Alexis Saenz').id, day: 'THURSDAY', day_index: 4, start_time: '12:30p', end_time: '1:50pm'},
  ...
  {text: 'Contemporary', studio_id: Studio.find_by(name: 'Movement Lifestyle').id, instructor_id: Instructor.find_by(name: 'Megan Lawson').id, day: 'FRIDAY', day_index: 5, start_time: '11:30a', end_time: '1:30pm'},
